<?php
class ControllerRcfAbout extends Model {
    ...
    public function getForm() {
        ...
        $data['action'] = $this->url->link('rcf/about/save', 'user_token=' . $this->session->data['user_token'], true);
        $this->response->setOutput($this->load->view('rcf/about', $data));
    }
}
