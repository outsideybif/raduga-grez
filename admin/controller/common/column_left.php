...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'rcf/home')) {
				$pages[] = array(
					'name'	   => "Главная",
					'href'     => $this->url->link('rcf/home', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			if ($this->user->hasPermission('access', 'rcf/about')) {
				$pages[] = array(
					'name'	   => "О нас",
					'href'     => $this->url->link('rcf/about', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			if ($this->user->hasPermission('access', 'rcf/wholesale')) {
				$pages[] = array(
					'name'	   => "Оптовые продажи",
					'href'     => $this->url->link('rcf/wholesale', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			if ($this->user->hasPermission('access', 'rcf/faq')) {
				$pages[] = array(
					'name'	   => "Ответы - вопросы",
					'href'     => $this->url->link('rcf/faq', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			if ($this->user->hasPermission('access', 'rcf/contact')) {
				$pages[] = array(
					'name'	   => "Контакты",
					'href'     => $this->url->link('rcf/contact', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			if ($this->user->hasPermission('access', 'rcf/settings')) {
				$pages[] = array(
					'name'	   => "Настройки",
					'href'     => $this->url->link('rcf/settings', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			...
			if ($this->user->hasPermission('access', 'stories/stories')) {
				$stories[] = array(
					'name'	   => "Список сторий",
					'href'     => $this->url->link('stories/stories', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
			...
			if ($this->user->hasPermission('access', 'stockist/stockist')) {
				$stockist[] = array(
					'name'	   => "Список продавцов",
					'href'     => $this->url->link('stockist/stockist', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()		
				);
			}	
