...
require('../assets/tools/Math10.js');
require('./locomotive-scroll.js');
import '../assets/tools/safari.js';
...
let req = require.context("../components", true, /\.(js|styl(us)?)$/);
req.keys().forEach(function (key) {
  req(key);
});

req = require.context("../", true, /^((?!node_modules).)*\.(pug)$/);
req.keys().forEach(function (key) {
  req(key);
});
