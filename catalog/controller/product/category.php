...
class ControllerProductCategory extends Controller {
	public function index() {
		...
		if ($category_info) {
			...
			$data['total_product_count'] = $this->model_catalog_product->getProductCount($category_id)['count'];
			
			//$data['total_product_count'] = 100;
			...
			$data["active_category"] = $this->model_catalog_category->getCategory($category_id);
	...
	public function loadMore(){
		...
		$json['total_product_count'] = $this->model_catalog_product->getProductCount($category_id)['count'];
